...
`)
        ...
        setTituloPaginaIndividual(
          curso.titulo_pagina_individual ||
            ""
        );

        setDescricaoPaginaIndividual(
          curso.descricao_pagina_individual ||
            ""
        );

        setLinhaDestaqueCard(
          curso.linha_destaque_card ||
            ""
        );

        const itensVoceVaiAprender =
          Array.isArray(
            curso.voce_vai_aprender
          )
            ? curso.voce_vai_aprender.filter(
                (
                  item
                ): item is string =>
                  typeof item ===
        ...
        setVoceVaiAprender(
          itensVoceVaiAprender.length >
            0
            ? itensVoceVaiAprender
            : [""]
        );
...
<Card>
  ...
  <CardContent className="space-y-6">
    <div className="space-y-2">
      ...
      <p className="text-xs text-zinc-500">
        Se ficar vazio, utilizaremos o título original
        do treinamento.
      </p>
    </div>
    ...
    <div className="space-y-2">
      ...
      <p className="text-xs text-zinc-500">
        Utilizada internamente como referência para
    ...
    <div className="space-y-3">
      <div>
        ...
        <p className="mt-1 text-xs text-zinc-500">
          Simulação do resultado de pesquisa.
        </p>
      </div>
